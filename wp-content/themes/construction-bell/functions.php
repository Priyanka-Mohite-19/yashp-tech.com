...
function constructionbell_scripts() {
    ...
    if ( is_rtl() ) {
		wp_enqueue_style( 'construction-light-rtl', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'rtl.css', array(), esc_attr( $constructionbell_version ) );	
	}
...
if ( ! function_exists( 'constructionbell_child_options' ) ) {
    ...
    function constructionbell_child_options( $wp_customize ) {
        ...
        $wp_customize->get_control('construction_light_search_layout')->section="construction_light_top_header";
        $wp_customize->get_control('construction_light_enable_search')->section="construction_light_top_header";
        $wp_customize->get_control('construction_light_menu_sidebar')->section="construction_light_top_header";
